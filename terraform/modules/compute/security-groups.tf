...
resource "aws_security_group" "ecs_alb" {
  ...
  vpc_id      = "${var.vpc_id}"
  tags        = "${merge(var.tags, map("Name", "${var.env}_ecs_alb_sg"))}"
}
...
resource "aws_security_group" "ecs_instance" {
  ...
  vpc_id      = "${var.vpc_id}"
  tags        = "${merge(var.tags, map("Name", "${var.env}_ecs_instance_sg"))}"
}
...
resource "aws_security_group" "bastion" {
  ...
  vpc_id      = "${var.vpc_id}"
  tags        = "${merge(var.tags, map("Name", "${var.env}_bastion_sg"))}"
}
...
resource "aws_security_group" "maintenance" {
  ...
  vpc_id      = "${var.vpc_id}"
  tags        = "${merge(var.tags, map("Name", "${var.env}_maintenance_sg"))}"
}
